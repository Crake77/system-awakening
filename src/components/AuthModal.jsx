...
const inputStyle = {
  ...
  background: '#1e1e3a', border: '1px solid #888', borderRadius: 4,
...
export default function AuthModal({ onClose }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: '#242448', border: '1px solid #777', borderRadius: 8,
        ...
        {step === 'email' ? (
          <>
            <p style={{ margin: '0 0 20px', fontSize: 13, color: '#ccd' }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 4, color: '#ccd', fontSize: 13, cursor: 'pointer',
          }}
        >
